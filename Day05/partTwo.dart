...
void main() {
  ...
  for (var move in moves) {
    ...
    var removed = listToRemove.sublist(listToRemove.length - move[0]);
    listToRemove.removeRange(listToRemove.length - move[0], listToRemove.length);
    listToAdd.addAll(removed);
  }
